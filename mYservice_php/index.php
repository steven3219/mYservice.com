...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-primary pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">mYservice.com</a>
    <span class="navbar-text">Satisfaction is the key of the happiness</span>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/p2.jpeg);">
    <div class="myclass mainHeading">
      <h1 class="text-danger font-weight-bold">WELCOME TO mYservice.com</h1>
      <p class="font-italic">Satisfaction is the key of the happiness</p>
  ...
  <div class="container" id="about">
    ...
    <div class="jumbotron">
      <h3 class="text-center">About mYservice.com</h3>
      <p>
        mYservice.com is India’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Pawan Kumar</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Anju Sharma</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Rekha Chauhan</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Ravindra Kumar &copy; 2019.
          </small>
